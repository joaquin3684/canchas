...
object Db {
  ...
  val initDb = DBIO.seq(
    ...
    Schemas.usuarios ++= Seq(
      ...
      Usuario("300", "300", "300".bcrypt, "300"),
      Usuario("400", "400", "400".bcrypt, "400"),
      Usuario("VENDEDORA", "VENDEDORA", "VENDEDORA".bcrypt, "VENDEDORA"),
      Usuario("CADETE", "CADETE", "CADETE".bcrypt, "CADETE"),
      Usuario("EXTERNO", "EXTERNO", "EXTERNO".bcrypt, "EXTERNO"),
      Usuario("PROMOTORA", "PROMOTORA", "PROMOTORA".bcrypt, "PROMOTORA"),
    ),
